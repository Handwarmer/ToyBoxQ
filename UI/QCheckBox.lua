...
QCheckBox Widget
-------------------------------------------------------------------------------]]
local Type, Version = "QCheckBox", 23
...
local function Control_OnEnter(frame)
	frame.obj:Fire("OnEnter", frame.obj);
end
...
--	local text = frame:CreateFontString(nil, "OVERLAY", "GameFontHighlightMedium")
